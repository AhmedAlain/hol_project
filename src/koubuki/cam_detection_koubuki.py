...
class image_converter:
    ...
    def __init__(self):
        ...
        self.image_sub = rospy.Subscriber("/kobuki/sensors/realsense/color/image_color", Image, self.callback)
        self.camera_info_sub = rospy.Subscriber("/kobuki/sensors/realsense/color/camera_info", CameraInfo, self.camera_info_callback)
